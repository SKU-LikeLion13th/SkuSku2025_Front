...
export default function CyberCampusAssignment() {
  ...
  return (
    <div className="relative text-black mobileContainer lg:min-h-screen lg:mb-32 mb-28">
      ...
      <div className="flex flex-col justify-center w-10/12 gap-16 mx-auto mt-28 fontBold lg:flex-row lg:gap-8 lg:w-9/12">
        {buttons.map((button, index) => (
          ...
          >
            ...
            <div className="text-base whitespace-pre-line fontRegular lg:whitespace-wrap">
              {button.subTitle}
            </div>
          </button>
        ))}
